  ...
  <el-collapse v-model="activeNames" @change="handleChange">
    ...
    <el-collapse-item name="2">
      ...
      <div style="text-align: left;">
        ...
        <p>为此站长在网上找了一个PCRE的安装包，还花了一块钱，</p>
        ...
        <p>关于yum install，站长还踩过很多坑，这里一并列出来，。</p>
    ...
    <el-collapse-item name="3">
      ...
      <div style="text-align: left;">
        ...
        <p><img style="max-height: 200px; max-width: 600px" src="https://linyujia.cn/share/pic-link/Yujia%2F50ba7d9b-dc0d-410a-9466-ea8552aca873%E5%BE%AE%E4%BF%A1%E6%88%AA%E5%9B%BE_20241002195848.png" alt=""></p>
